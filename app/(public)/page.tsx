...
const SERVICES = [
  {
    ...
    text: "Handpicked luxe villa's met eigen zwembad, persoonlijke butler en adembenemend uitzicht.",
    href: "/villas",
    num: "01",
  },
  {
    ...
    text: "Privé rondleidingen langs tempels, rijstterrassen en verborgen watervallen op maat gemaakt.",
    href: "/tours",
    num: "02",
  },
  {
    ...
    text: "Van romantische kliffendining tot verborgen lokale warungs. Wij reserveren de beste tafels.",
    href: "/restaurants",
    num: "03",
  },
  {
    icon: Car,
    title: "Transfers",
    subtitle: "Stijlvol vervoer",
    text: "Privé transferservice in normaal, luxe of VIP-klasse met lokale chauffeurs die het eiland kennen.",
    href: "/transfers",
    num: "04",
  },
  {
    icon: FileText,
    title: "Visum",
    subtitle: "Zorgeloze reisdocumenten",
    text: "Wij regelen jouw Indonesisch visum snel en correct — geen papierwerk, geen stress.",
    href: "/visum",
    num: "05",
  },
  {
    ...
    text: "Van eerste kennismaking tot de dag dat je thuiskomt — wij plannen elk detail van jouw Bali reis.",
    href: "/contact",
    num: "06",
  },
];
...
const HOE_HET_WERKT = [
  {
    num: "01",
    title: "Vertel ons",
    tagline: "Jouw droom, onze missie.",
    ...
    alt: "Bali rijstterrassen bij zonsopgang",
    meta: "Stap 1 / Vertel",
  ...
  },
  {
    num: "02",
    title: "Wij plannen",
    tagline: "Elk detail, perfect geregeld.",
    ...
    alt: "Balinese tempel bij schemering",
    meta: "Stap 2 / Plan",
  ...
  },
  {
    num: "03",
    title: "Jij geniet",
    tagline: "Bali op zijn allerbest.",
    ...
    alt: "Luxe villa zwembad op Bali",
    meta: "Stap 3 / Geniet",
...
const VILLA_PREVIEWS = [
  {
    ...
    price: "€285",
    beds: 4,
    image: "https://images.unsplash.com/photo-1540541338537-1220205ac293?w=800&q=85&auto=format&fit=crop",
    tag: "Meest geboekt",
  },
  {
    name: "Cliffside Uluwatu",
    region: "Uluwatu",
    price: "€420",
    beds: 6,
    image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&q=85&auto=format&fit=crop",
    tag: "Nieuw",
  },
  {
    ...
    price: "€190",
    beds: 3,
    image: "https://images.unsplash.com/photo-1560184897-ae75f418493e?w=800&q=85&auto=format&fit=crop",
    tag: "Populair",
  },
];
...
const TESTIMONIALS = [
  {
    quote: "BaliLiving heeft onze huwelijksreis letterlijk perfect gemaakt. Elke villa, elk restaurant, elke tour was precies wat we gehoopt hadden. Beter dan een reisbureau, het voelde als een vriend die op Bali woont.",
    name: "Sophie & Thomas",
    location: "Rotterdam",
    stars: 5,
  },
  {
    quote: "Onze gezinsvakantie met vier kinderen was een droom. Edwin en Citty dachten aan alles — van kindvriendelijke activiteiten tot een villa met beveiligd zwembad. Wij komen zeker terug.",
    name: "Maria van den Berg",
    location: "Amsterdam",
    stars: 5,
  },
  {
    quote: "Professioneel, persoonlijk en altijd beschikbaar. Midden in de nacht een vraag? Ze reageerden binnen het uur. BaliLiving is de enige manier om Bali te ontdekken.",
    name: "Robert Dekker",
    location: "Utrecht",
    stars: 5,
  },
    ...
    >
      ...
      <div className="absolute top-3 left-4 right-4 flex items-center justify-between z-20">
        ...
        <div className="flex items-baseline gap-1">
          ...
          <span className="font-mono text-[9px] uppercase tracking-widest text-[#F5F0E8]/40">
            vandaag
          </span>
        </div>
      </div>

      {/* Balinese temple silhouette bar */}
      <svg
        className="absolute left-3 right-3 top-9 h-5 w-[calc(100%-24px)]"
        viewBox="0 0 400 20"
      ...
      <div className="absolute inset-x-0 top-14 bottom-11 overflow-hidden">
        {petals.map((p, i) => (
          ...
          >
            ...
            {/* Lotus petal shape */}
            <path
              d="M10 1 C 7 5, 2 10, 2 16 Q 2 24 10 27 Q 18 24 18 16 C 18 10, 13 5, 10 1 Z"
              fill={`url(#pg-${i})`}
              fillOpacity="0.85"
            />
            <path
              d="M10 4 C 9 8, 7 12, 7 16"
              fill="none"
              stroke="#E8C96A"
              strokeWidth="0.7"
              strokeOpacity="0.5"
      ...
      <svg className="absolute bottom-9 left-3 right-3 h-2.5 w-[calc(100%-24px)]" viewBox="0 0 200 10" preserveAspectRatio="none">
        <path
          d="M0,5 Q12.5,2 25,5 T50,5 T75,5 T100,5 T125,5 T150,5 T175,5 T200,5"
          fill="none" stroke="#C9A84C" strokeOpacity="0.35" strokeWidth="1.2"
        />
      </svg>
        ...
        {ripples.map((r, i) => (
          <span
            ...
            style={{
              ...
              width: "4px",
              height: "4px",
              animation: `petal-ripple 2.8s ease-out ${r.delay} infinite`,
            }}
          />
        ))}
      </div>
      ...
      <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between z-20">
        <div className="flex items-center gap-2">
          <span
            ...
            style={{ background: dotColor, boxShadow: `0 0 0 0 ${dotColor}80`, animation: "ring-pulse-gold 2.5s infinite" }}
          />
          <span className="font-mono text-[10px] text-[#F5F0E8]/60 truncate max-w-[120px]">
            {status.text}
          </span>
        </div>
        <span
...
function HoeHetWerkt() {
  ...
  return (
    <section ref={containerRef} className="relative px-4 sm:px-6 py-20 sm:py-28">
      <div className="max-w-7xl mx-auto mb-16 px-2 sm:px-4">
        <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-[#C9A84C]/70">
          ╱ Hoe het werkt
        </span>
        <h2
          className="text-4xl sm:text-5xl md:text-6xl font-light text-[#F5F0E8] mt-4 leading-tight"
      ...
      <div className="space-y-8">
        {HOE_HET_WERKT.map((step, idx) => (
          <article
            key={idx}
            className="protocol-card sticky top-24 sm:top-28 mx-auto max-w-6xl bg-[#131E14] border border-[#C9A84C]/15 rounded-3xl overflow-hidden shadow-2xl shadow-black/50"
          >
            <div className="grid lg:grid-cols-5 gap-0 min-h-[65vh]">
              {/* Left content */}
              <div className="lg:col-span-3 p-8 sm:p-12 lg:p-16 flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-[#F5F0E8]/40">
                    {step.meta}
                  </span>
                  <span className="font-mono text-[10px] uppercase tracking-widest text-[#C9A84C] bg-[#C9A84C]/10 px-3 py-1 rounded-full border border-[#C9A84C]/20">
                    BaliLiving
                  </span>
                </div>
                ...
                <div className="my-10 lg:my-0 lg:py-10">
                  <span
                    className="font-light text-[6rem] sm:text-[9rem] leading-none text-[#C9A84C]/10 -mb-4 block"
                    style={{ fontFamily: "var(--font-cormorant)" }}
                  >
                    {step.num}
                  </span>
                  <h3
                    className="text-3xl sm:text-4xl md:text-5xl font-light text-[#F5F0E8] leading-tight"
                    style={{ fontFamily: "var(--font-cormorant)" }}
                  >
                    {step.title}
                  </h3>
                  <p
                    className="text-2xl sm:text-3xl italic text-[#C9A84C] mt-3"
                    style={{ fontFamily: "var(--font-cormorant)" }}
                  >
                    {step.tagline}
                  </p>
                ...
                <div>
                  <p className="text-[#F5F0E8]/60 text-base sm:text-lg leading-relaxed mb-8">
                    {step.text}
                  </p>
                  <ul className="space-y-3">
                    {step.checks.map((c) => (
                      <li key={c} className="flex items-center gap-3 text-[#F5F0E8]/70 text-sm">
                        <CheckCircle2 className="h-4 w-4 text-[#C9A84C] flex-shrink-0" strokeWidth={2} />
                        {c}
                      </li>
                    ))}
                  </ul>
              ...
              <div className="lg:col-span-2 relative overflow-hidden min-h-[280px] lg:min-h-full bg-[#0F1A10]">
                ...
                <div className="absolute top-5 left-5 flex items-center gap-2 glass-dark rounded-full pl-3 pr-4 py-1.5">
                  ...
                  <span className="font-mono text-[10px] uppercase tracking-widest text-[#F5F0E8]/80">
                    Stap {step.num}
                  </span>
                </div>
                <div className="absolute bottom-4 right-4 font-mono text-[10px] uppercase tracking-widest text-[#F5F0E8]/50">
                  {step.num} / BaliLiving
                </div>
              </div>
            </div>
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".hero-h1", {
        y: 60, opacity: 0, duration: 1.1, delay: 0.5, ease: "power3.out",
      });
      gsap.from(".hero-sub", {
        y: 24, opacity: 0, duration: 0.8, delay: 0.85, ease: "power3.out",
      });
      gsap.from(".hero-cta", {
        y: 20, opacity: 0, duration: 0.7, delay: 1.05, stagger: 0.12, ease: "power3.out",
      });
      gsap.from(".hero-scroll", {
        opacity: 0, duration: 0.8, delay: 1.5, ease: "power2.out",
      });
  ...
  return (
    <>
      ...
      >
        ...
        {/* Floating lotus petal particles (top-right) */}
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center pt-28 sm:pt-36 pb-20">
          <div className="max-w-5xl mx-auto w-full flex flex-col items-center">
            <p className="hero-eyebrow text-[#C9A84C] text-[0.65rem] tracking-[0.45em] uppercase mb-10">
              Welkom bij BaliLiving
            </p>

            <h1
              className="hero-h1 text-5xl sm:text-7xl lg:text-9xl font-light text-[#F5F0E8] leading-none mb-8"
              style={{ fontFamily: "var(--font-cormorant)" }}
            >
              Bali op
              <br />
            ...
            <div className="hero-sub flex items-center gap-4 my-8">
            ...
            <p className="hero-sub text-[#F5F0E8]/70 text-lg max-w-xl leading-relaxed mb-14">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <Link
                href="/villas"
                className="hero-cta magnetic-btn inline-flex items-center gap-2 px-10 py-4 bg-[#C9A84C] text-[#1C2B1E] text-xs tracking-[0.3em] uppercase font-semibold hover:bg-[#E8C96A]"
              >
                Ontdek Villa&apos;s
              ...
              <Link
                href="/over-ons"
                className="hero-cta magnetic-btn inline-flex items-center gap-2 px-10 py-4 border border-[#F5F0E8]/30 text-[#F5F0E8] text-xs tracking-[0.3em] uppercase hover:border-[#C9A84C] hover:text-[#C9A84C]"
              >
                Onze Aanpak
        ...
        {/* Scroll indicator */}
        <div className="hero-scroll absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none">
      ...
      <section className="bg-[#C9A84C] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 text-center">
            {STATS.map((s, i) => (
              <div key={s.label} className="reveal-section" style={{ transitionDelay: `${i * 80}ms` }}>
                <div
                  className="text-4xl md:text-6xl font-light text-[#1C2B1E] mb-1"
                  style={{ fontFamily: "var(--font-cormorant)" }}
                >
                  <CountUp target={s.target} duration={1800 + i * 200} />
                  {s.suffix}
                </div>
                <div className="text-[#1C2B1E]/65 text-[0.65rem] tracking-[0.25em] uppercase">
                  {s.label}
                </div>
                <div className="mt-3 h-px bg-[#1C2B1E]/15 overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-transparent via-[#1C2B1E]/40 to-transparent"
      ...
      <section className="py-32 sm:py-40 max-w-7xl mx-auto px-6">
        ...
        >
          <motion.div variants={fadeUp}>
            <p className="text-[#C9A84C] text-[0.65rem] tracking-[0.4em] uppercase mb-6">
              Waarom BaliLiving
            </p>
            <h2
            ...
            <Link
              href="/over-ons"
              className="lift-on-hover inline-flex items-center gap-3 mt-10 text-[#C9A84C] text-[0.7rem] tracking-[0.3em] uppercase group"
            >
              Lees ons verhaal
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="lg:col-span-2">
              <p className="text-[#C9A84C] text-[0.65rem] tracking-[0.4em] uppercase mb-5">
                ╱ Real-time beschikbaarheid
              </p>
              <h2
                className="text-4xl sm:text-5xl md:text-6xl font-light text-[#F5F0E8] leading-tight mb-6"
                style={{ fontFamily: "var(--font-cormorant)" }}
              >
                Altijd een villa
                <span className="block italic text-[#C9A84C]">voor jou beschikbaar.</span>
              </h2>
              <p className="text-[#F5F0E8]/55 text-base leading-relaxed max-w-lg">
                Ons live netwerk van villa-eigenaren en lokale partners zorgt dat wij altijd
                de perfecte match voor jou kunnen vinden — op elk moment van het jaar.
              </p>
              <div className="flex flex-wrap gap-6 mt-8">
                {[
                  { icon: Shield, text: "Gecureerde selectie" },
                  { icon: Clock, text: "24/7 support" },
                  { icon: Users, text: "Lokaal netwerk" },
                  { icon: MapPin, text: "Heel Bali" },
                ].map(({ icon: Icon, text }) => (
            ...
            {/* Right — signature lotus rain animation */}
            <motion.div variants={fadeUp}>
      ...
      <section className="py-28 sm:py-36 bg-[#131E14]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.p variants={fadeUp} className="text-[#C9A84C] text-[0.65rem] tracking-[0.45em] uppercase mb-4">
              Onze Diensten
            </motion.p>
            <motion.h2
              variants={fadeUp}
          ...
          >
            {SERVICES.map((s) => (
              <motion.div key={s.title} variants={fadeUp}>
                <Link
                  href={s.href}
                  className="group block bg-[#131E14] p-10 hover:bg-[#1C2B1E] transition-all duration-500 h-full"
                >
                  <div className="flex justify-between items-start mb-8">
                    <span
                      className="text-[#C9A84C]/25 text-sm tracking-[0.3em] font-light"
                      style={{ fontFamily: "var(--font-cormorant)" }}
                    >
                      {s.num}
                    </span>
                  ...
                  <p className="text-[#C9A84C] text-[0.6rem] tracking-[0.3em] uppercase mb-3">
                    {s.subtitle}
                  </p>
                  <h3
                  ...
                  <p className="text-[#F5F0E8]/45 text-sm leading-relaxed mb-8">
                    {s.text}
                  </p>
                  <div className="flex items-center gap-3 text-[#C9A84C] text-[0.65rem] tracking-[0.2em] uppercase">
                    ...
                    <ArrowUpRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 -ml-2 transition-all duration-300" strokeWidth={2} />
                  </div>
                </Link>
              </motion.div>
            ))}
      ...
      <section className="py-28 sm:py-36 max-w-7xl mx-auto px-6">
        ...
        >
          <motion.div variants={fadeUp} className="flex items-end justify-between mb-16">
            <div>
              <p className="text-[#C9A84C] text-[0.65rem] tracking-[0.4em] uppercase mb-4">
                Uitgelichte Villa&apos;s
              </p>
              <h2
                className="text-4xl sm:text-5xl md:text-6xl font-light text-[#F5F0E8] leading-tight"
                style={{ fontFamily: "var(--font-cormorant)" }}
              >
                Onze topkeuzes
                <span className="block italic text-[#C9A84C]">op dit moment</span>
              </h2>
            </div>
            <Link
              href="/villas"
              className="lift-on-hover hidden md:flex items-center gap-3 text-[#C9A84C] text-[0.65rem] tracking-[0.3em] uppercase group"
            >
              Alle villa&apos;s
              <span className="w-6 h-px bg-[#C9A84C] group-hover:w-12 transition-all duration-300" />
            </Link>
                ...
                <Link href="/villas" className="group block overflow-hidden rounded-sm">
                  <div className="relative overflow-hidden aspect-[4/5]">
                    ...
                    <div className="absolute top-4 left-4 glass-dark border border-[#C9A84C]/20 px-3 py-1 rounded-full">
                      <span className="font-mono text-[10px] uppercase tracking-widest text-[#C9A84C]">
                        {v.tag}
                      </span>
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      <div className="flex items-end justify-between">
                        <div>
                          <p className="font-mono text-[10px] uppercase tracking-widest text-[#C9A84C]/70 mb-1">
                            {v.region}
                          </p>
                          <h3
                            className="text-2xl font-light text-[#F5F0E8] leading-tight"
                            style={{ fontFamily: "var(--font-cormorant)" }}
                          >
                            {v.name}
                          </h3>
                        ...
                        <div className="text-right">
                          <p className="text-[#C9A84C] text-xl font-light" style={{ fontFamily: "var(--font-cormorant)" }}>
                            {v.price}
                          </p>
                          <p className="text-[#F5F0E8]/40 text-[0.65rem] tracking-widest uppercase">
                            /nacht
                          </p>
                        </div>
                      </div>
          ...
          <motion.div variants={fadeUp} className="mt-10 text-center md:hidden">
            <Link
              href="/villas"
              className="magnetic-btn inline-flex items-center gap-2 border border-[#C9A84C]/40 text-[#C9A84C] text-xs tracking-[0.3em] uppercase px-8 py-3"
            >
              Alle Villa&apos;s
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div variants={fadeUp} className="text-center mb-20">
              <p className="text-[#C9A84C] text-[0.65rem] tracking-[0.45em] uppercase mb-4">
                Ervaringen
              </p>
              <h2
                className="text-4xl sm:text-5xl md:text-6xl font-light text-[#F5F0E8]"
                style={{ fontFamily: "var(--font-cormorant)" }}
              >
                Wat onze reizigers
                <span className="block italic text-[#C9A84C]">zeggen</span>
              </h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {TESTIMONIALS.map((t, i) => (
                <motion.div
                  ...
                  className="group bg-[#131E14] border border-[#C9A84C]/10 p-8 hover:border-[#C9A84C]/25 transition-colors duration-500"
                >
                  {/* Stars */}
                  ...
                  <blockquote
                    className="text-[#F5F0E8]/70 text-base leading-relaxed mb-8 italic"
                    style={{ fontFamily: "var(--font-cormorant)" }}
                  >
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
      ...
      <section className="py-28 sm:py-36 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="text-4xl sm:text-5xl md:text-6xl font-light text-[#F5F0E8] mb-20"
            style={{ fontFamily: "var(--font-cormorant)" }}
          >
            Jouw reis, volledig
            <br />
          ...
          <motion.div variants={stagger} className="grid md:grid-cols-3 gap-16">
            {[
              ...
              <motion.div key={item.title} variants={fadeUp} className="flex flex-col items-center text-center group">
                ...
                <h3
                  className="text-2xl sm:text-3xl font-light text-[#F5F0E8] mb-4"
                  style={{ fontFamily: "var(--font-cormorant)" }}
                >
                  {item.title}
                </h3>
      ...
      <section className="py-32 bg-[#C9A84C] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.p variants={fadeUp} className="font-mono text-[0.6rem] uppercase tracking-[0.4em] text-[#1C2B1E]/60 mb-6">
              Gratis kennismakingsgesprek
            </motion.p>
            <motion.h2
              variants={fadeUp}
              className="text-5xl sm:text-6xl md:text-8xl font-light text-[#1C2B1E] mb-6 leading-none"
              style={{ fontFamily: "var(--font-cormorant)" }}
            >
              Klaar om Bali te
              <br />
            ...
            <motion.p variants={fadeUp} className="text-[#1C2B1E]/65 mb-12 text-lg leading-relaxed max-w-xl mx-auto">
              Plan een gratis kennismakingsgesprek met een van onze Bali-experts en ontdek
              hoe wij jouw droomreis werkelijkheid maken.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="magnetic-btn inline-flex items-center justify-center gap-2 px-12 py-5 bg-[#1C2B1E] text-[#C9A84C] text-xs tracking-[0.3em] uppercase hover:bg-[#243628]"
              >
                Start jouw reis
                <ArrowUpRight className="h-4 w-4" strokeWidth={2.2} />
              </Link>
              <Link
                href="/villas"
                className="magnetic-btn inline-flex items-center justify-center gap-2 px-12 py-5 border-2 border-[#1C2B1E]/30 text-[#1C2B1E] text-xs tracking-[0.3em] uppercase hover:border-[#1C2B1E] hover:bg-[#1C2B1E]/5"
              >
                Bekijk Villa&apos;s
                <ArrowRight className="h-4 w-4" strokeWidth={2.2} />
              </Link>
