...
export default function HomeClient({ villas }: { villas: Villa[] }) {
  return (
    <>
      ...
      {/* ─── VILLA PREVIEW (real data from Supabase) ──────────────── */}
      {villas.length > 0 && (
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6">
                        <div className="flex items-end justify-between">
                          <div>
                            ...
                            <p className="text-[#F5F0E8]/50 text-xs mt-1">{v.bedrooms} slaapkamers</p>
                          </div>
                          <div className="text-right">
                            <p className="text-[#C9A84C] text-xl font-light" style={{ fontFamily: "var(--font-cormorant)" }}>€{v.price_per_night.toLocaleString("nl-NL")}</p>
