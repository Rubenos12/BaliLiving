...
export const metadata: Metadata = {
  ...
  description: "De beste restaurants op Bali, persoonlijk geselecteerd door BaliLiving. Van beachclubs in Seminyak tot rijstterras-diners in Ubud.",
  alternates: { canonical: "https://www.baliliving.nl/restaurants" },
  openGraph: {
    title: "Restaurants op Bali — BaliLiving",
    description: "Persoonlijk geselecteerde restaurants op Bali — van beachclubs tot rijstterras-diners.",
    url: "https://www.baliliving.nl/restaurants",
  },
};
